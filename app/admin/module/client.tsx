...
export default function ({ moduleList }: { moduleList: IModuleList }) {
  ...
  return (
    <div className="w-full" >
      ...
      {/* module list table */}
      <div className="w-full overflow-x-scroll overflow-y-hidden hide-scrollbar">
            ...
            >
              ...
              <td className="whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                <Menu as="div" className="relative inline-block text-left">
                  ...
                  >
                    <MenuItems className="absolute right-0 z-30 mt-2 w-[143px] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ">
                      <div className="py-1">
                        <MenuItem>
                          {({ focus }) => (
                            <Link
